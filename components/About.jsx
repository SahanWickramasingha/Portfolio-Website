    ...
    const data = [
        {
            ...
            description: 'Java, Python, JavaScript, PHP, Prolog',
        },
        {
            name: 'Education',
            icon1: '/assets/edu-icon.png',
            icon2: '/assets/edu-icon-dark.png',
            description: 'Bsc IT in OUSL',
        },
        {
            name: 'Projects',
        ...
        <div id="about" className="w-full px-[12%] py-10 scroll-mt-20">
            ...
            <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
                ...
                <div className="flex-1">
                    <p className="mb-10 max-w-2xl font-Ovo">I’m passionate about creating technology that thinks—AI-driven applications that make everyday tasks smarter, faster, and more intuitive. My journey spans mobile, desktop, and web development, where I specialize in embedding intelligence into user-friendly interfaces.
