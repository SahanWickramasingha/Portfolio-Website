export default function Services() {
    const services = [
        ...
        },
        {
            ...
            description: 'mobile application development is the process of building, programming...',
            link: '#',
        },
        {
            name: 'UI/ UX design',
        ...
        },
        {
            ...
            description: 'AI development is the process of building, programming...',
            link: '#',
        }
    ];
    return (
        <div id="services" className="w-full px-[12%] py-10 scroll-mt-20">
            ...
            <p className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">I build intelligent and scalable mobile, desktop, and web applications by leveraging modern frameworks and machine learning tools.</p>
